...
/**
 * Description text for a SelectItem. Renders as a span that pushes to the
 * right side of the item (ml-auto), uses muted styling, and truncates
 * gracefully when the viewport is narrow.
 */
function SelectItemDescription({
  ...
  return (
    <span
      ...
      className={cn(
        "text-muted-foreground ml-auto text-xs min-w-0 truncate",
        className,
      )}
      {...props}
    />
