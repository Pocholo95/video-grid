...
describe("gridUtils", () => {
  ...
  describe("getVrCropRect", () => {
    ...
    it("returns a centered square crop for sbs-left-fisheye", () => {
      const result = getVrCropRect(1920, 1080, "sbs-left-fisheye");
      expect(result.sw).toBe(960);
      expect(result.sh).toBe(960);
      expect(result.sx).toBe(0);
      expect(result.sy).toBe(60);
    });

    it("returns a centered square crop for sbs-right-fisheye", () => {
      const result = getVrCropRect(1920, 1080, "sbs-right-fisheye");
      expect(result.sw).toBe(960);
      expect(result.sh).toBe(960);
      expect(result.sx).toBe(960);
      expect(result.sy).toBe(60);
    ...
    it("returns a centered square crop for tb-left-fisheye", () => {
      const result = getVrCropRect(1920, 1080, "tb-left-fisheye");
      expect(result.sw).toBe(540);
      expect(result.sh).toBe(540);
      expect(result.sx).toBe(690);
      expect(result.sy).toBe(0);
    });

    it("returns a centered square crop for tb-right-fisheye", () => {
      const result = getVrCropRect(1920, 1080, "tb-right-fisheye");
      expect(result.sw).toBe(540);
      expect(result.sh).toBe(540);
      expect(result.sx).toBe(690);
      expect(result.sy).toBe(540);
  ...
  describe("vrModeLabel", () => {
    ...
    it("returns label for sbs-left-fisheye", () => {
      expect(vrModeLabel("sbs-left-fisheye")).toBe(
        "SBS Fisheye - Crop Left Eye",
      );
    });

    it("returns label for sbs-right-fisheye", () => {
      expect(vrModeLabel("sbs-right-fisheye")).toBe(
        "SBS Fisheye - Crop Right Eye",
      );
    });

    it("returns label for tb-left-fisheye", () => {
      expect(vrModeLabel("tb-left-fisheye")).toBe(
        "TB Fisheye - Crop Top (Left Eye)",
      );
    });

    it("returns label for tb-right-fisheye", () => {
      expect(vrModeLabel("tb-right-fisheye")).toBe(
        "TB Fisheye - Crop Bottom (Right Eye)",
      );
    });
  });
